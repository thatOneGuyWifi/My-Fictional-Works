...
Kandra forces can only control physical (and metaphysical) aspects of reality, kandra forces do not control abstract parts of reality. And kandra forces that seem like it does only controls the physical aspect of it. For example: kandra-love force (the kandra force which controls "love") only controls the physical side of love, which for love's case is the neurological and chemical process love.

There is a hierarchical system to kandra forces. **"Sub Kandra Force(s)"** or simply **"Sub Force(s)"**. Sub forces are kandra forces that lie under another kandra force. For example, take the kandra-weight force (the kandra force which controls weight), that kandra force falls under the kandra-gravitational force (the kandra force which controls gravity), as gravity effects weight. Another example, the kandra-proton force, which falls under the kandra-atom force, which falls under the kandra-chemistry force. So its sub force of another sub force.

Since every force is from kandra, every force is technically a sub kandra force. But the kandra forces that are only sub forces of kandra and not any other sub force is called the **"Fundamental Kandra Force(s)"** or simply **"Fundamental Force(s)"**. Every kandra force branches out from the fundamental forces.
