...
Now before we go further, let's talk about IDs. Every kandra force and factor has a unique ID that distinguishes themselves from others. IDs are written in ansof and are generated by kandra. IDs follow a structure and can reveal some information about the said force/factor. Here is the ID structure for kandra forces:
